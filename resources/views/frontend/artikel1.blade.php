      ...
      <div class="col-lg-9">
        <div class="left-side">
          <div class="item-holder">
            <div class="image-box">
              <figure>
                <a href="\artikel1F"><img loading="lazy" class="img-fluid" src="{{asset('assetsjs/images/artikelkes/artikel1.png')}}" alt=""></a>
              </figure>
            </div>
            <div class="content-text">
              <h4>Tips Agar tetap aman selama masa kehamilan</h4>
